...
<script>
import { Tab as LineTab, Tabs as LineTabs } from 'skyline/components/tabs';
import { TabBar as LineTabBar } from 'skyline/components/tab-bar';
import { TabButton as LineTabButton } from 'skyline/components/tab-button';
import { Icon as LineIcon } from 'skyline/components/icon';
