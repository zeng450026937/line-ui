...
describe('datetime-util', () => {
  describe('convertDataToISO', () => {
    ...
    describe('time', () => {
      ...
      it('prints seconds', () => {
        expect(convertDataToISO({ hour: 15, minute: 32, second: 42 })).toEqual(
          '15:32:42'
        );
      });

      it('pads seconds', () => {
        expect(convertDataToISO({ hour: 15, minute: 32, second: 2 })).toEqual(
          '15:32:02'
        );
      });
